        ...
        for (int x = 0; x < XRES / CELL; x++)
            if (sim->bmap[y][x])
            {
                ...
                case 0:
                    ...
                    {
                        float xf = x * CELL + CELL * 0.5f - 0.5f;
                        float xc = 0, xd = 0, xu = 0;   //Kahan summation algorithm
                        float yf = y * CELL + CELL * 0.5f - 0.5f;
                        float yc = 0, yd = 0, yu = 0;   //Kahan summation algorithm
